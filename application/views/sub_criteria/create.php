        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="page-title">Tambah Sub Kriteria</h3>
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <!-- Horizontal Form -->
                        <div class="box">
                            <form class="form-horizontal form-element" action="<?php echo base_url('sub_criteria/store') ?>" method="post" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 control-label">Nama Sub Kriteria</label>

                                        <div class="col-sm-10">
                                            <input type="text" name="nama_sub_kriteria" class="form-control" id="inputPassword3" placeholder="Masukkan nama sub kriteria" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" min="1" name="prioritas" class="form-control" id="inputPassword3" placeholder="Masukkan prioritas" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
