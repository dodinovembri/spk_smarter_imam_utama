            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <!-- Horizontal Form -->
                        <div class="box">
                            <form class="form-horizontal form-element" action="<?php echo base_url('user/update/');
                                                                                echo $user->id; ?>" method="post" enctype="multipart/form-data">
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="status" id="" class="form-control" required>
                                                <option value="<?php echo $user->status; ?>"><?php echo check_status($user->status); ?></option>
